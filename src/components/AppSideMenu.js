...
const UserCard = React.memo(
    ({ user, role, logoUri, insetTop, compactTop = false }) => {
            ...
            <View
                ...
                <View style={UC.avatarWrap}>
                    {logoUri ? (
                        ...
                        <LinearGradient
                            colors={[C.primary, "#7C9EFF"]}
                            style={UC.avatarGrad}>
                            <Text style={UC.avatarInitials}>
                                {initials || "U"}
                            </Text>
                        </LinearGradient>
                    )}
        ...
        return (
            <Animated.View style={{ transform: [{ scale: scaleAnim }] }}>
                <TouchableOpacity
                    style={[
                        MI.item,
                        active && MI.itemActive,
                        locked && MI.itemLocked,
                    ]}
                    onPress={handlePress}
                    activeOpacity={0.8}>
                    {/* Active left bar */}
                    ...
                    {/* Active chevron dot */}
                    {locked ? (
                        <Text style={MI.lockedText}>Locked</Text>
                    ) : active ? (
                        <View style={MI.activeDot} />
                    ) : null}
                </TouchableOpacity>
            </Animated.View>
        );
        ...
        <Modal
            ...
            <Animated.View
                ...
                <UserCard
                    ...
                    role={role}
                    logoUri={logoUri}
                    insetTop={isStaff ? 80 : insets.top + 10}
                    compactTop={isStaff}
                />
                ...
                <ScrollView
                    ...
                    <MenuSection title="Workspace">
                        ...
                        <MenuItem
                            ...
                            active={isActive("BulkWhatsAppScreen")}
                            locked={
                                !hasPlanFeature(
                                    billingInfo?.plan,
                                    "whatsapp",
                    ...
                    <MenuSection title="CRM">
                        <MenuItem
                            ...
                            locked={
                                !hasPlanFeature(billingInfo?.plan, "enquiries")
                            }
                        />
                        <MenuItem
                            icon="call-outline"
                            ...
                            locked={
                                !hasPlanFeature(billingInfo?.plan, "followups")
                            }
                        />
                        <MenuItem
                            icon="mail-outline"
                            label="Email"
                            onPress={() =>
                                navWithFeature("EmailScreen", "email", "Email")
                            }
                    ...
                    <MenuSection title="Communication">
                        <MenuItem
                            ...
                            locked={
                                !hasPlanFeature(billingInfo?.plan, "team_chat")
                            }
                        />
                    </MenuSection>
                    {/* Footer */}
