                ...
                {loading ? (
                    ...
                    <ScrollView
                        ...
                        <View style={S.tableHead}>
                            ...
                            <Text style={[S.th, S.thP]}>Pen</Text>
                            <Text style={[S.th, S.thI]}>Pro</Text>
                            <Text style={[S.th, S.thC]}>Done</Text>
                            <Text style={[S.th, S.thT]}>Total</Text>
                        </View>
                        ...
                        {rows.map((r, idx) => (
                            <View
                                ...
                                <View style={[S.cell, S.pillAll]}>
                                    <Text style={S.cellTxt}>
                                        {r.pending + r.inProgress + r.completed}
                                    </Text>
                                </View>
                            </View>
                        ))}
...
const S = StyleSheet.create({
    ...
    pillAll: { backgroundColor: T.bgSecondary, borderColor: T.line },
});
