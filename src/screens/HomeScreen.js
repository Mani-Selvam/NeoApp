...
const TradingStageChart = ({ data = [], h = 170, chartWidth = 340 }) => {
  ...
  return (
    <View>
      <Svg width="100%" height={h + 30} viewBox={`0 0 ${chartWidth} ${h + 30}`}>
        <Defs>
          <SvgLinearGradient id="tradingBg" x1="0%" y1="0%" x2="100%" y2="0%">
            <Stop offset="0%" stopColor="#DCE4F0" />
            <Stop offset="50%" stopColor="#F7F9FD" />
            <Stop offset="100%" stopColor="#D7E8F7" />
          </SvgLinearGradient>
          <SvgLinearGradient id="tradingFill" x1="0%" y1="0%" x2="0%" y2="100%">
            <Stop offset="0%" stopColor="#73AEEA" stopOpacity="0.42" />
            <Stop offset="100%" stopColor="#73AEEA" stopOpacity="0.08" />
          </SvgLinearGradient>
        </Defs>
        <Rect
          x="0"
        ...
        {areaPath ? <Path d={areaPath} fill="url(#tradingFill)" /> : null}
        {linePath ? (
          <Path
            d={linePath}
            fill="none"
  ...
  return (
    <View style={{ marginBottom: 14 }}>
      ...
      >
        ...
        <Text style={{ fontSize: 13, color, fontWeight: "800" }}>{value}</Text>
      </View>
      <View
        style={{
          height: 7,
        ...
        return (
          <View
            ...
            style={{
              ...
              height: 6,
              borderRadius: 3,
              backgroundColor: i < filled ? "#fff" : "rgba(255,255,255,0.2)",
              left: cx - 3,
              top: cy - 3,
            }}
          />
    ...
    >
      ...
      <SafeAreaView edges={["top"]} style={S.topBar}>
        ...
        >
          ...
          <View style={{ flex: 1, marginLeft: 12, marginRight: 12 }}>
            ...
            <Text
              style={[S.topName, isTablet || isDesktop ? { fontSize: 22 } : {}]}
              numberOfLines={1}
            >
              {user?.name || "Manager"}
            </Text>
      ...
      >
        ...
        >
          ...
          >
            ...
            <View style={S.activityCard}>
              <View style={S.countRow}>
                <TouchableOpacity
                  style={[S.countPill, { borderColor: C.violet + "55" }]}
                  activeOpacity={0.88}
                  onPress={() =>
                ...
                <TouchableOpacity
                  style={[S.countPill, { borderColor: C.rose + "55" }]}
                  activeOpacity={0.88}
                  onPress={() =>
                    navigation.navigate("FollowUp", {
          ...
          >
            <LinearGradient
              ...
              style={[S.heroCard, isTablet || isDesktop ? { padding: 28 } : {}]}
            >
              <View
                style={{
                  position: "absolute",
              ...
              >
                ...
                <RingMeter pct={cr} size={isTablet || isDesktop ? 90 : 80} />
              </View>
              ...
              >
                {[
                  ...
                  <View key={i} style={{ alignItems: "center" }}>
                    <Text
                      style={{
                        fontSize: isTablet || isDesktop ? 18 : 16,
                        color: "#fff",
                        fontWeight: "900",
                        letterSpacing: -0.3,
                      }}
        ...
        <View style={[S.body, { paddingHorizontal: hPad }]}>
          ...
          {/* PIPELINE */}
          <MotiView
            from={skipAnim ? { opacity: 1 } : { opacity: 0, translateY: 14 }}
            animate={{ opacity: 1, translateY: 0 }}
          ...
          >
            ...
            <View style={S.card}>
              <View style={S.pipelineHeroRow}>
                <View style={{ flex: 1 }}>
                  <Text style={S.pipelineEyebrow}>Lead momentum</Text>
                  <Text
                    style={[
                      S.pipelineTotalValue,
                      isTablet || isDesktop ? { fontSize: 38 } : {},
                    ]}
                  >
                    {stats.totalEnquiry}
                  </Text>
                ...
                <View style={S.pipelineLeaderCard}>
                  <Text style={S.pipelineLeaderLabel}>Top stage</Text>
                  <Text
                    style={[
                      S.pipelineLeaderValue,
                      {
                        color: pipelineLeader?.color || C.blue,
                      },
                    ]}
                  >
              ...
              <View style={S.pipelineLegendGrid}>
                {pipelineStages.map((stage) => {
                  const pct =
                    stats.totalEnquiry > 0
                      ? Math.round((stage.value / stats.totalEnquiry) * 100)
                      : 0;
                  return (
                    <View key={stage.label} style={S.pipelineLegendPill}>
                      <View style={S.pipelineLegendHead}>
                        <View style={S.pipelineLegendLabelRow}>
                          <View
                            style={[
                              S.pipelineLegendDot,
                              {
                          ...
                          />
                          <Text style={S.pipelineLegendLabel}>
                            {stage.label}
                          </Text>
                        </View>
                        <Text
                          style={[S.pipelineLegendPct, { color: stage.color }]}
                        >
                          {pct}%
                        </Text>
                      </View>
                      <Text
                        style={[S.pipelineLegendValue, { color: stage.color }]}
                      >
                        {stage.value}
                      </Text>
                      <View style={S.pipelineLegendBarTrack}>
                        <View
                          style={[
                      ...
                      <Text style={S.pipelineLegendMeta}>{stage.hint}</Text>
                    </View>
                  );
                })}
              </View>
            ...
            <View style={S.card}>
              ...
              >
                <View>
                  ...
                  <Text
                    style={{
                      fontSize: isTablet || isDesktop ? 28 : 24,
                      color: C.emerald,
                      fontWeight: "900",
                      letterSpacing: -0.5,
                    }}
