...
const SECURITY_ALERTS_CHANNEL_ID = "security_alerts_v1";
...
const _scheduleRichFollowupNotification = async (data, dedupKey) => {
    try {
        ...
        // FIX: Use the user's selected voice language instead of hardcoded "en"
        const lang = await AsyncStorage.getItem("notificationVoiceLang") === "ta" ? "ta" : "en";
