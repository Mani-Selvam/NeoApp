...
export const getCompanyWhatsappTemplate = async () => {
    const client = await getApiClient();
    const response = await client.get("/users/company/whatsapp-template");
    return response.data;
};

export const updateCompanyWhatsappTemplate = async (payload) => {
    const client = await getApiClient();
    const response = await client.put("/users/company/whatsapp-template", payload);
    return response.data;
};
