...
const dueBody = ({ lang, name, actorName, activityType, timeLabel }) => {
    ...
    if (lang === "ta") {
        ...
        return `${prefix} • ${timeBit}இப்போது ${getActivityLabel(lang, activityKey)} நேரம். தயவு செய்து தொடரவும்.`;
    }
...
export const getMissedFollowUpsSummaryTexts = ({ lang = "en", count }) => {
    if (lang === "ta") {
        const body =
            count === 1
                ? "உங்களுக்கு 1 பின்தொடர்தல் தவறியுள்ளது. பார்க்க இங்கே கிளிக் செய்யவும்."
                : `உங்களுக்கு ${count} பின்தொடர்தல்கள் தவறியுள்ளன. பார்க்க இங்கே கிளிக் செய்யவும்.`;
        const voice =
            count === 1
                ? "உங்களுக்கு ஒரு பின்தொடர்தல் தவறியுள்ளது."
                : `உங்களுக்கு ${count} பின்தொடர்தல்கள் தவறியுள்ளன.`;
        return {
            title: "தவறிய பின்தொடர்தல்கள்",
            body,
            voice,
        };
    }
