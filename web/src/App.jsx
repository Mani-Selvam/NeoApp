...
import AdminStaffPayments from "./pages/superadmin/AdminStaffPayments";
...
export default function App() {
    ...
    const showExpiryModal = Boolean(isAuthenticated && user?.passwordExpired);
        ...
        <>
            <Routes>
                ...
                <Route element={<ProtectedRoute />}>
                    ...
                    <Route path="/superadmin/admin-staff-payments" element={<AdminStaffPayments />} />
            ...
            {showExpiryModal && <PasswordExpiryModal />}
        </>
    );
}
